...
{
    public string url = "http://files.flixite.com/unity/roy.bin"; // URL where the AssetBundle is
    public int version = 1; // The version of the AssetBundle

    public string assetName = "Camera"; // Name of the Asset to be loaded from the AssetBundle
